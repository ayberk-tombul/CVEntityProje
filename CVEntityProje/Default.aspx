...
<head>
    ...
    <!-- Custom Theme files -->
    <link href="webb/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
    <link href="webb/css/style.css" type="text/css" rel="stylesheet" media="all">
    <!-- font-awesome icons -->
    <link href="webb/css/fontawesome-all.min.css" rel="stylesheet">
    <!-- //Custom Theme files -->
    <!-- online-fonts -->
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="webb/images/profile2.png" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">TURKS</a></h1>
            <p class="top_hdp mt-2">There are two unknowns in the World. The Poles and the Turks!</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
